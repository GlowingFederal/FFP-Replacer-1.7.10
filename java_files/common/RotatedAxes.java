...
public class RotatedAxes {
  ...
  public void rotateLocalYaw(float rotateBy) {
    this.rotationMatrix.rotate(rotateBy * 3.1415927F / 180.0F, getYAxis().normalise(null));
    convertMatrixToAngles();
  }
  
  public void rotateLocalPitch(float rotateBy) {
    this.rotationMatrix.rotate(rotateBy * 3.1415927F / 180.0F, getZAxis().normalise(null));
    convertMatrixToAngles();
  }
  
  public void rotateLocalRoll(float rotateBy) {
    this.rotationMatrix.rotate(rotateBy * 3.1415927F / 180.0F, getXAxis().normalise(null));
    convertMatrixToAngles();
  }
  ...
  public void rotateLocal(float rotateBy, Vector3f rotateAround) {
    this.rotationMatrix.rotate(rotateBy * 3.1415927F / 180.0F, findLocalVectorGlobally(rotateAround));
    convertMatrixToAngles();
  }
