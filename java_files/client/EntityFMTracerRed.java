...
public class EntityFMTracerRed extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    float scale = 0.6F - this.field_70546_d * 0.1F;
    ...
    par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * (colorIntensity - this.field_70546_d * 0.2F), this.field_70551_j * (colorIntensity - this.field_70546_d * 0.2F), 1.0F - this.field_70546_d * 0.1F);
