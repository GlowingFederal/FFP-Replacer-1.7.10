...
public class EntitytankDeath extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    float scale = 0.1F + this.field_70546_d * 12.0F - (this.field_70546_d * this.field_70546_d) * 1.5F;
    ...
    par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * 0.0F, this.field_70551_j * 0.0F, 1.0F - (this.field_70546_d * this.field_70546_d * this.field_70546_d) * 9.0E-4F);
