...
public class EntitySmallSmoke extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    float scale = 2.5F + this.field_70546_d * 0.01F;
    float xPos = (float)(this.field_70169_q + 1.0E-4D * (this.field_70165_t - this.field_70169_q) * par2 - field_70556_an);
    float yPos = (float)(this.field_70167_r + 1.0E-5D * (this.field_70163_u - this.field_70167_r) * par2 - field_70554_ao);
    float zPos = (float)(this.field_70166_s + (this.field_70161_v - this.field_70166_s) * par2 - field_70555_ap);
    float colorIntensity = 1.0F;
    par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * colorIntensity, this.field_70551_j * colorIntensity, 1.0F - (this.field_70546_d * this.field_70546_d * this.field_70546_d) * 3.21E-7F);
