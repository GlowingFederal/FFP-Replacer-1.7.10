...
public class EntitySmokeShellMustard extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    (FMLClientHandler.instance().getClient()).field_71446_o.func_110577_a(new ResourceLocation("flansmod", "particle/FMSmokeMustard.png"));
    ...
    par1Tessellator.func_78369_a(this.field_70552_h * 8.0F * colorIntensity, this.field_70553_i * 7.7F * colorIntensity, this.field_70551_j * 6.0F * colorIntensity, 1.0F - (this.field_70546_d * this.field_70546_d * this.field_70546_d) * 8.1E-9F);
