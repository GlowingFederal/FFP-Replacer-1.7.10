...
public class ModelPersianVeiledHelm extends ModelCustomArmour {
  ...
  private void initheadModel_1() {
    ...
    this.headModel[12] = new ModelRendererTurbo((ModelBase)this, 105, 1, this.textureX, this.textureY);
    ...
    this.headModel[15] = new ModelRendererTurbo((ModelBase)this, 73, 17, this.textureX, this.textureY);
    this.headModel[16] = new ModelRendererTurbo((ModelBase)this, 73, 9, this.textureX, this.textureY);
    ...
    this.headModel[29] = new ModelRendererTurbo((ModelBase)this, 81, 33, this.textureX, this.textureY);
    this.headModel[30] = new ModelRendererTurbo((ModelBase)this, 97, 33, this.textureX, this.textureY);
    this.headModel[31] = new ModelRendererTurbo((ModelBase)this, 113, 33, this.textureX, this.textureY);
    this.headModel[32] = new ModelRendererTurbo((ModelBase)this, 1, 41, this.textureX, this.textureY);
    this.headModel[33] = new ModelRendererTurbo((ModelBase)this, 1, 17, this.textureX, this.textureY);
    this.headModel[34] = new ModelRendererTurbo((ModelBase)this, 121, 17, this.textureX, this.textureY);
    this.headModel[35] = new ModelRendererTurbo((ModelBase)this, 121, 25, this.textureX, this.textureY);
    this.headModel[36] = new ModelRendererTurbo((ModelBase)this, 89, 25, this.textureX, this.textureY);
    this.headModel[37] = new ModelRendererTurbo((ModelBase)this, 17, 41, this.textureX, this.textureY);
    this.headModel[38] = new ModelRendererTurbo((ModelBase)this, 25, 41, this.textureX, this.textureY);
    this.headModel[39] = new ModelRendererTurbo((ModelBase)this, 33, 41, this.textureX, this.textureY);
