...
public class ModelIrishSegmentata extends ModelCustomArmour {
  int textureX = 128;
  
  int textureY = 64;
  
  public ModelIrishSegmentata() {
  ...
  private void initbodyModel_1() {
    this.bodyModel[0] = new ModelRendererTurbo((ModelBase)this, 97, 25, this.textureX, this.textureY);
    this.bodyModel[1] = new ModelRendererTurbo((ModelBase)this, 0, 53, this.textureX, this.textureY);
    this.bodyModel[2] = new ModelRendererTurbo((ModelBase)this, 0, 57, this.textureX, this.textureY);
    this.bodyModel[3] = new ModelRendererTurbo((ModelBase)this, 0, 55, this.textureX, this.textureY);
    this.bodyModel[4] = new ModelRendererTurbo((ModelBase)this, 0, 53, this.textureX, this.textureY);
    this.bodyModel[5] = new ModelRendererTurbo((ModelBase)this, 0, 55, this.textureX, this.textureY);
    this.bodyModel[6] = new ModelRendererTurbo((ModelBase)this, 0, 57, this.textureX, this.textureY);
    this.bodyModel[7] = new ModelRendererTurbo((ModelBase)this, 97, 9, this.textureX, this.textureY);
    this.bodyModel[8] = new ModelRendererTurbo((ModelBase)this, 41, 17, this.textureX, this.textureY);
    ...
    this.bodyModel[14] = new ModelRendererTurbo((ModelBase)this, 49, 41, this.textureX, this.textureY);
    this.bodyModel[15] = new ModelRendererTurbo((ModelBase)this, 49, 49, this.textureX, this.textureY);
    ...
    this.bodyModel[19] = new ModelRendererTurbo((ModelBase)this, 97, 9, this.textureX, this.textureY);
    this.bodyModel[0].addShapeBox(0.0F, -0.2F, -2.5F, 9, 5, 5, 0.0F, 0.0F, 0.3F, 0.2F, -4.0F, 0.1F, 0.2F, -4.0F, 0.1F, 0.2F, 0.0F, 0.3F, 0.2F, 0.0F, 0.0F, 1.0F, -4.0F, -2.0F, 0.8F, -4.0F, -2.0F, 0.8F, 0.0F, -0.5F, 0.8F);
    this.bodyModel[0].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[1].addShapeBox(-6.0F, 1.0F, -4.4F, 3, 1, 1, 0.0F, -1.0F, 0.0F, -0.8F, -1.0F, 0.0F, -0.6F, -1.0F, 0.0F, 0.2F, -1.0F, 0.0F, 0.4F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, 0.8F);
    this.bodyModel[1].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[2].addShapeBox(-6.0F, 3.0F, -4.4F, 3, 1, 1, 0.0F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, 0.8F, -1.0F, 0.0F, -0.8F, -1.0F, 0.0F, -0.6F, -1.0F, 0.0F, 0.2F, -1.0F, 0.0F, 0.4F);
    this.bodyModel[2].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[3].addShapeBox(-6.0F, 2.0F, -4.4F, 3, 1, 1, 0.0F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, 0.8F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, 0.8F);
    this.bodyModel[3].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[4].addShapeBox(3.0F, 1.0F, -4.4F, 3, 1, 1, 0.0F, -1.0F, 0.0F, -0.6F, -1.0F, 0.0F, -0.8F, -1.0F, 0.0F, 0.4F, -1.0F, 0.0F, 0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, 0.8F, 0.0F, 0.0F, -0.2F);
    this.bodyModel[4].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[5].addShapeBox(3.0F, 2.0F, -4.4F, 3, 1, 1, 0.0F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, 0.8F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, 0.8F, 0.0F, 0.0F, -0.2F);
    this.bodyModel[5].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[6].addShapeBox(3.0F, 3.0F, -4.4F, 3, 1, 1, 0.0F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -1.2F, 0.0F, 0.0F, 0.8F, 0.0F, 0.0F, -0.2F, -1.0F, 0.0F, -0.6F, -1.0F, 0.0F, -0.8F, -1.0F, 0.0F, 0.4F, -1.0F, 0.0F, 0.2F);
    this.bodyModel[6].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[7].addShapeBox(-4.5F, 0.8F, -2.5F, 9, 1, 5, 0.0F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.2F, 0.1F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F);
    this.bodyModel[7].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[8].addShapeBox(-4.5F, 4.8F, -2.5F, 9, 1, 5, 0.0F, -0.1F, 0.0F, 0.2F, -0.1F, 0.0F, 0.2F, -0.1F, 0.0F, 0.2F, -0.1F, 0.2F, 0.2F, 0.1F, 0.2F, 0.4F, 0.1F, 0.2F, 0.4F, 0.1F, 0.2F, 0.4F, 0.1F, 0.2F, 0.4F);
    this.bodyModel[8].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[9].addShapeBox(-4.5F, 8.8F, -2.5F, 9, 1, 5, 0.0F, -0.3F, 0.0F, -0.1F, -0.3F, 0.0F, -0.1F, -0.3F, 0.0F, -0.1F, -0.3F, 0.2F, -0.1F, -0.1F, 0.2F, 0.1F, -0.1F, 0.2F, 0.1F, -0.1F, 0.2F, 0.1F, -0.1F, 0.2F, 0.1F);
    this.bodyModel[9].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[10].addShapeBox(-4.5F, 7.8F, -2.5F, 9, 1, 5, 0.0F, -0.3F, 0.0F, 0.0F, -0.3F, 0.0F, 0.0F, -0.3F, 0.0F, 0.0F, -0.3F, 0.2F, 0.0F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F, 0.2F);
    this.bodyModel[10].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[11].addShapeBox(-4.5F, 6.8F, -2.5F, 9, 1, 5, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.2F, 0.0F, 0.0F, 0.2F, 0.3F, 0.0F, 0.2F, 0.3F, 0.0F, 0.2F, 0.3F, 0.0F, 0.2F, 0.3F);
    this.bodyModel[11].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[12].addShapeBox(-4.5F, 5.8F, -2.5F, 9, 1, 5, 0.0F, -0.2F, 0.0F, 0.1F, -0.2F, 0.0F, 0.1F, -0.2F, 0.0F, 0.1F, -0.2F, 0.2F, 0.1F, 0.1F, 0.2F, 0.3F, 0.1F, 0.2F, 0.3F, 0.1F, 0.2F, 0.3F, 0.1F, 0.2F, 0.3F);
    this.bodyModel[12].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[13].addShapeBox(-4.5F, 9.8F, -2.5F, 9, 1, 5, 0.0F, -0.2F, 0.0F, -0.15F, -0.2F, 0.0F, -0.15F, -0.2F, 0.0F, -0.15F, -0.2F, 0.2F, -0.15F, 0.2F, 0.2F, 0.5F, 0.2F, 0.2F, 0.5F, 0.2F, 0.2F, 0.5F, 0.2F, 0.2F, 0.5F);
    this.bodyModel[13].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[14].addShapeBox(-4.5F, 10.8F, -2.5F, 9, 1, 5, 0.0F, 0.0F, 0.0F, 0.2F, 0.0F, 0.0F, 0.2F, 0.0F, 0.0F, 0.2F, 0.0F, 0.2F, 0.2F, 0.4F, 0.2F, 0.7F, 0.4F, 0.2F, 0.7F, 0.4F, 0.2F, 0.7F, 0.4F, 0.2F, 0.7F);
    this.bodyModel[14].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[15].addShapeBox(-4.5F, 11.8F, -2.5F, 9, 1, 5, 0.0F, 0.2F, 0.0F, 0.5F, 0.2F, 0.0F, 0.5F, 0.2F, 0.0F, 0.5F, 0.2F, 0.2F, 0.5F, 0.7F, 0.2F, 1.0F, 0.7F, 0.2F, 1.0F, 0.7F, 0.2F, 1.0F, 0.7F, 0.2F, 1.0F);
    this.bodyModel[15].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[16].addShapeBox(-9.0F, -0.2F, -2.5F, 9, 5, 5, 0.0F, -4.0F, 0.1F, 0.2F, 0.0F, 0.3F, 0.2F, 0.0F, 0.3F, 0.2F, -4.0F, 0.1F, 0.2F, -4.0F, -2.0F, 0.8F, 0.0F, 0.0F, 1.0F, 0.0F, -0.5F, 0.8F, -4.0F, -2.0F, 0.8F);
    this.bodyModel[16].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[17].addShapeBox(-4.5F, 1.8F, -2.5F, 9, 1, 5, 0.0F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.2F, 0.1F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F);
    this.bodyModel[17].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[18].addShapeBox(-4.5F, 2.8F, -2.5F, 9, 1, 5, 0.0F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.2F, 0.1F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F);
    this.bodyModel[18].func_78793_a(0.0F, 0.0F, 0.0F);
    this.bodyModel[19].addShapeBox(-4.5F, 3.8F, -2.5F, 9, 1, 5, 0.0F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F, 0.2F, 0.1F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F);
  ...
  private void initleftArmModel_1() {
    ...
    this.leftArmModel[2].addShapeBox(-1.0F, -0.6F, -2.0F, 4, 1, 4, 0.0F, 0.4F, 1.2F, 0.2F, 0.2F, 1.2F, 0.2F, 0.2F, 1.2F, 0.2F, 0.4F, 1.2F, 0.2F, 0.3F, 3.4F, 0.3F, 0.4F, 3.4F, 0.3F, 0.4F, 3.4F, 0.3F, 0.3F, 3.4F, 0.3F);
    ...
    this.leftArmModel[5].addShapeBox(0.0F, -2.0F, -2.0F, 4, 4, 4, 0.0F, 0.0F, 0.3F, 0.7F, -1.0F, 0.1F, 0.3F, -1.0F, 0.1F, 0.3F, 0.0F, 0.3F, 0.7F, 0.0F, -1.2F, 1.3F, -0.5F, -3.5F, 0.5F, -0.5F, -3.5F, 0.5F, 0.0F, -1.2F, 1.3F);
  ...
  private void initrightArmModel_1() {
    ...
    this.rightArmModel[4] = new ModelRendererTurbo((ModelBase)this, 73, 9, this.textureX, this.textureY);
    this.rightArmModel[5] = new ModelRendererTurbo((ModelBase)this, 1, 33, this.textureX, this.textureY);
    this.rightArmModel[0].addShapeBox(-3.0F, -0.6F, -2.0F, 4, 1, 4, 0.0F, 0.2F, 1.2F, 0.2F, 0.4F, 1.2F, 0.2F, 0.4F, 1.2F, 0.2F, 0.2F, 1.2F, 0.2F, 0.4F, 3.4F, 0.3F, 0.3F, 3.4F, 0.3F, 0.3F, 3.4F, 0.3F, 0.4F, 3.4F, 0.3F);
    this.rightArmModel[0].func_78793_a(0.0F, 0.0F, 0.0F);
    this.rightArmModel[1].addShapeBox(-3.0F, 5.7F, -2.0F, 4, 3, 4, 0.0F, 0.3F, 2.0F, 0.3F, 0.3F, 2.0F, 0.3F, 0.3F, 2.0F, 0.3F, 0.3F, 2.0F, 0.3F, 0.2F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F, 0.2F, 0.0F, 0.2F);
    this.rightArmModel[1].func_78793_a(0.0F, 0.0F, 0.0F);
    this.rightArmModel[2].addShapeBox(-3.0F, 9.0F, -2.0F, 4, 3, 4, 0.0F, 0.8F, 0.5F, 0.8F, 0.8F, 0.5F, 0.8F, 0.8F, 0.5F, 0.8F, 0.8F, 0.5F, 0.8F, 0.2F, -2.2F, 0.2F, 0.2F, -2.2F, 0.2F, 0.2F, -2.2F, 0.2F, 0.2F, -2.2F, 0.2F);
    ...
    this.rightArmModel[4].addShapeBox(-3.0F, 3.9F, -2.0F, 4, 2, 4, 0.0F, 0.4F, -0.8F, 0.5F, 0.4F, -0.8F, 0.5F, 0.4F, 0.2F, 0.4F, 0.4F, 0.2F, 0.4F, 0.4F, -0.8F, 0.5F, 0.4F, -0.8F, 0.5F, 0.4F, 0.2F, 0.5F, 0.4F, 0.2F, 0.5F);
    this.rightArmModel[4].func_78793_a(0.0F, 0.0F, 0.0F);
    this.rightArmModel[5].addShapeBox(-4.0F, -2.0F, -2.0F, 4, 4, 4, 0.0F, -1.0F, 0.1F, 0.3F, 0.0F, 0.3F, 0.7F, 0.0F, 0.3F, 0.7F, -1.0F, 0.1F, 0.3F, -0.5F, -3.5F, 0.5F, 0.0F, -1.2F, 1.3F, 0.0F, -1.2F, 1.3F, -0.5F, -3.5F, 0.5F);
  ...
  private void initskirtFrontModel_1() {
    ...
    this.skirtFrontModel[1].addShapeBox(-4.0F, 0.5F, -2.0F, 8, 2, 2, 0.0F, 0.8F, 0.0F, 1.0F, 0.8F, 0.0F, 1.0F, 0.8F, 0.0F, 0.5F, 0.8F, 0.0F, 0.5F, 1.4F, 1.0F, 1.4F, 1.4F, 1.0F, 1.4F, 1.4F, 1.0F, 1.7F, 1.4F, 1.0F, 1.7F);
  ...
  private void initskirtRearModel_1() {
    ...
    this.skirtRearModel[1].addShapeBox(-4.0F, 0.5F, 0.0F, 8, 2, 2, 0.0F, 0.8F, 0.0F, 0.5F, 0.8F, 0.0F, 0.5F, 0.8F, 0.0F, 1.0F, 0.8F, 0.0F, 1.0F, 1.4F, 1.0F, 1.8F, 1.4F, 1.0F, 1.7F, 1.4F, 1.0F, 1.4F, 1.4F, 1.0F, 1.4F);
