...
public class ModelAegeanSword extends ModelGun {
  ...
  public ModelAegeanSword() {
    ...
    this.gunModel[0].func_78793_a(0.2F, -2.8F, 0.5F);
    ...
    this.gunModel[1].func_78793_a(0.2F, -7.8F, 0.5F);
    ...
    this.gunModel[2].func_78793_a(0.2F, -16.3F, 0.5F);
    ...
    this.gunModel[3].func_78793_a(0.2F, -2.3F, 0.5F);
    ...
    this.gunModel[4].func_78793_a(0.2F, 1.7F, 0.5F);
    ...
    this.gunModel[5].func_78793_a(0.2F, -2.8F, 0.5F);
    ...
    this.gunModel[6].func_78793_a(0.2F, -0.3F, 0.5F);
    ...
    this.gunModel[7].func_78793_a(0.2F, -1.3F, 0.5F);
