...
public class ModelGK80helmet1990sCamo extends ModelCustomArmour {
  int textureX = 64;
  
  int textureY = 64;
  
  public ModelGK80helmet1990sCamo() {
    this.headModel = new ModelRendererTurbo[25];
    this.headModel[0] = new ModelRendererTurbo((ModelBase)this, 26, 12, this.textureX, this.textureY);
    this.headModel[1] = new ModelRendererTurbo((ModelBase)this, 22, 11, this.textureX, this.textureY);
    this.headModel[2] = new ModelRendererTurbo((ModelBase)this, 23, 9, this.textureX, this.textureY);
    ...
    this.headModel[10] = new ModelRendererTurbo((ModelBase)this, 26, 13, this.textureX, this.textureY);
    this.headModel[11] = new ModelRendererTurbo((ModelBase)this, 24, 10, this.textureX, this.textureY);
    this.headModel[12] = new ModelRendererTurbo((ModelBase)this, 35, 10, this.textureX, this.textureY);
    this.headModel[13] = new ModelRendererTurbo((ModelBase)this, 24, 11, this.textureX, this.textureY);
    ...
    this.headModel[20] = new ModelRendererTurbo((ModelBase)this, 23, 12, this.textureX, this.textureY);
