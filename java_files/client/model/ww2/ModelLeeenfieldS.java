...
public class ModelLeeenfieldS extends ModelGun {
  ...
  public ModelLeeenfieldS() {
    ...
    this.defaultScopeModel[0] = new ModelRendererTurbo((ModelBase)this, 40, 29, this.textureX, this.textureY);
    this.defaultScopeModel[1] = new ModelRendererTurbo((ModelBase)this, 40, 29, this.textureX, this.textureY);
    this.defaultScopeModel[2] = new ModelRendererTurbo((ModelBase)this, 40, 34, this.textureX, this.textureY);
    this.defaultScopeModel[3] = new ModelRendererTurbo((ModelBase)this, 40, 41, this.textureX, this.textureY);
    this.defaultScopeModel[4] = new ModelRendererTurbo((ModelBase)this, 40, 50, this.textureX, this.textureY);
    this.defaultScopeModel[5] = new ModelRendererTurbo((ModelBase)this, 40, 59, this.textureX, this.textureY);
