...
public class ModelRPK extends ModelGun {
  public ModelRPK() {
    ...
    this.defaultStockModel[0].addBox(-7.0F, 2.0F, -1.0F, 3, 2, 2);
    this.defaultStockModel[1] = new ModelRendererTurbo((ModelBase)this, 18, 6, textureX, textureY);
    this.defaultStockModel[1].addBox(-11.0F, 0.0F, -1.0F, 4, 4, 2);
    ...
    this.defaultBarrelModel[0].addBox(14.0F, 2.5F, -0.5F, 8, 1, 1);
    this.defaultBarrelModel[1] = new ModelRendererTurbo((ModelBase)this, 16, 12, textureX, textureY);
    this.defaultBarrelModel[1].addBox(22.0F, 2.5F, -0.5F, 1, 2, 1);
    this.defaultBarrelModel[2] = new ModelRendererTurbo((ModelBase)this, 38, 0, textureX, textureY);
    this.defaultBarrelModel[2].addShapeBox(20.0F, -2.5F, -1.0F, 1, 5, 1, 0.0F, 0.0F, 0.0F, 3.0F, 0.0F, 0.0F, 3.0F, 0.0F, 0.0F, -3.0F, 0.0F, 0.0F, -3.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
    this.defaultBarrelModel[3] = new ModelRendererTurbo((ModelBase)this, 38, 0, textureX, textureY);
    this.defaultBarrelModel[3].addShapeBox(20.0F, -2.5F, 0.0F, 1, 5, 1, 0.0F, 0.0F, 0.0F, -3.0F, 0.0F, 0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 0.0F, 0.0F, 3.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
    ...
    this.ammoModel[0].addBox(4.0F, -1.0F, -1.0F, 3, 3, 2);
    this.ammoModel[1] = new ModelRendererTurbo((ModelBase)this, 20, 12, textureX, textureY);
    this.ammoModel[1].addBox(5.0F, -3.0F, -1.0F, 3, 2, 2);
    this.ammoModel[2] = new ModelRendererTurbo((ModelBase)this, 30, 7, textureX, textureY);
    this.ammoModel[2].addBox(6.0F, -5.0F, -1.0F, 3, 2, 2);
