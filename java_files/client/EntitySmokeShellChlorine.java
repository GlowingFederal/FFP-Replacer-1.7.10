...
public class EntitySmokeShellChlorine extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    (FMLClientHandler.instance().getClient()).field_71446_o.func_110577_a(new ResourceLocation("flansmod", "particle/FMSmokeChlorine.png"));
    float scale = 15.0F + this.field_70546_d * 0.01F;
    ...
    par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity * 2.0F, this.field_70553_i * colorIntensity * 2.75F, this.field_70551_j * colorIntensity * 1.5F, 1.0F - (this.field_70546_d * this.field_70546_d * this.field_70546_d) * 8.1E-9F);
