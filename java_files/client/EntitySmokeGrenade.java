...
public class EntitySmokeGrenade extends EntityFX {
  ...
  public void func_70071_h_() {
    ...
    if (this.field_70546_d++ >= this.field_70547_e)
      func_70106_y(); 
    this.field_70181_x -= 0.08D * this.field_70545_g;
    func_70091_d(this.field_70159_w, this.field_70181_x, this.field_70179_y);
    this.field_70159_w *= 1.29D;
    this.field_70181_x *= 1.29D;
    this.field_70179_y *= 1.29D;
    ...
    for (int i = 0; i < NUM; i++) {
      ...
      FlansMod.proxy.spawnParticle("explode", this.field_70169_q + dx * i, this.field_70167_r + dy * i, this.field_70166_s + dz * i, 0.0D, 0.0D, 0.0D);
    } 
