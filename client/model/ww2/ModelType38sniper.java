...
public class ModelType38sniper extends ModelGun {
  ...
  public ModelType38sniper() {
    ...
    this.gunModel[15] = new ModelRendererTurbo((ModelBase)this, 0, 112, this.textureX, this.textureY);
    this.gunModel[16] = new ModelRendererTurbo((ModelBase)this, 0, 50, this.textureX, this.textureY);
    this.gunModel[17] = new ModelRendererTurbo((ModelBase)this, 0, 50, this.textureX, this.textureY);
    this.gunModel[18] = new ModelRendererTurbo((ModelBase)this, 0, 50, this.textureX, this.textureY);
    this.gunModel[19] = new ModelRendererTurbo((ModelBase)this, 0, 50, this.textureX, this.textureY);
    ...
    this.pumpModel[0] = new ModelRendererTurbo((ModelBase)this, 30, 130, this.textureX, this.textureY);
    this.pumpModel[0].func_78790_a(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
