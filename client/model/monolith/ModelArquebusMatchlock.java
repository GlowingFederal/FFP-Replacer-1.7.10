...
public class ModelArquebusMatchlock extends ModelGun {
  ...
  private void initgunModel_1() {
    ...
    this.gunModel[14] = new ModelRendererTurbo((ModelBase)this, 25, 33, this.textureX, this.textureY);
    this.gunModel[15] = new ModelRendererTurbo((ModelBase)this, 33, 33, this.textureX, this.textureY);
    this.gunModel[16] = new ModelRendererTurbo((ModelBase)this, 41, 33, this.textureX, this.textureY);
    this.gunModel[17] = new ModelRendererTurbo((ModelBase)this, 1, 41, this.textureX, this.textureY);
    this.gunModel[18] = new ModelRendererTurbo((ModelBase)this, 9, 41, this.textureX, this.textureY);
    this.gunModel[19] = new ModelRendererTurbo((ModelBase)this, 17, 41, this.textureX, this.textureY);
    this.gunModel[20] = new ModelRendererTurbo((ModelBase)this, 25, 41, this.textureX, this.textureY);
