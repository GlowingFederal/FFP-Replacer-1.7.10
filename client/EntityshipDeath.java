...
public class EntityshipDeath extends EntityFX {
  ...
  public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    float scale = 0.1F + this.field_70546_d * 25.0F - (this.field_70546_d * this.field_70546_d) * 2.0F;
    ...
    par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * (colorIntensity - this.field_70546_d * 0.005F), this.field_70551_j * (colorIntensity - this.field_70546_d * 0.5F), 1.0F - (this.field_70546_d * this.field_70546_d * this.field_70546_d) * 0.0025F);
